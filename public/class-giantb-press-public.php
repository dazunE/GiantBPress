 ...
 * @subpackage Giantb_Press/public
 */
...
class Giantb_Press_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/giantb-press-public.css', array(), $this->version, 'all' );
